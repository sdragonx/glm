...
*/
#ifndef GLM_MAT2X2_HPP20220219020158
#define GLM_MAT2X2_HPP20220219020158
...
// mat2 *= mat2
template<typename T>
GLM_API mat<2, 2, T>& mat<2, 2, T>::operator*=(const mat<2, 2, T>& other)
{
    *this = mat2_mul(*this, other);
    return *this;
}
...
#endif// GLM_MAT2X2_HPP20220219020158
