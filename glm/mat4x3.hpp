...
*/
#ifndef GLM_MAT4X3_HPP20220226090655
#define GLM_MAT4X3_HPP20220226090655
...
// vec4 = mat4x3 x vec4
template<typename T>
GLM_API vec<4, T> operator*(const mat<4, 3, T>& m, const vec<4, T>& v)
{
...
#endif// GLM_MAT4X3_HPP20220226090655
