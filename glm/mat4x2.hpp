...
*/
#ifndef GLM_MAT4X2_HPP20220226090655
#define GLM_MAT4X2_HPP20220226090655
...
// vec4 = mat4x2 x vec4
template<typename T>
GLM_API vec<4, T> operator*(const mat<4, 2, T>& m, const vec<4, T>& v)
{
...
#endif// GLM_MAT4X2_HPP20220226090655
